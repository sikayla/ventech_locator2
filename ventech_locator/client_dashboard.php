    ...
    <div class="flex">
        <aside class="w-64 bg-white p-5 shadow-lg flex flex-col flex-shrink-0 overflow-y-auto">
            ...
            <ul class="space-y-2 flex-grow">
                ...
                <li><a href="add_venue.php" class="sidebar-link flex items-center text-gray-700 hover:text-orange-600 hover:bg-orange-50 rounded p-2"><i class="fas fa-plus-square fa-fw mr-3 w-5 text-center"></i>Add Venue</a></li>
                <li><a href="client_profile.php" class="sidebar-link flex items-center text-gray-700 hover:text-orange-600 hover:bg-orange-50 rounded p-2"><i class="fas fa-user-circle fa-fw mr-3 w-5 text-center"></i>Profile</a></li>
                 <li><a href="reservations_manage.php" class="sidebar-link flex items-center text-gray-700 hover:text-orange-600 hover:bg-orange-50 rounded p-2"><i class="fas fa-calendar-check fa-fw mr-3 w-5 text-center"></i>Manage Bookings</a></li>
        ...
        <main class="flex-1 p-6 md:p-8 lg:p-10 overflow-y-auto bg-gray-50">
            ...
            <section>
                <div class="flex justify-between items-center mb-4 flex-wrap gap-4">
                     ...
                     <a href="reservations_manage.php" class="text-sm text-blue-600 hover:text-blue-800 font-medium">
