    ...
    <img src="https://storage.googleapis.com/a1aa/image/K_EDQPTQu2U4iz3tp8MzfHSgPnSlvbtIy4OxGn8rihQ.jpg" alt="Modern Venue Space" class="w-full h-96 object-cover brightness-75" /> <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/50 to-transparent flex flex-col justify-between items-center text-center text-white p-4 md:p-8">
        ...
        <div class="w-full flex justify-between items-center hero-overlay-content">
            ...
            <nav class="space-x-4 md:space-x-6 lg:space-x-8 flex items-center text-sm md:text-base">
                ...
                <?php if ($isLoggedIn): ?>
                    <div class="relative">
                        <button class="hover:text-yellow-400 transition duration-150 focus:outline-none font-medium">
                            <i class="fas fa-user mr-1"></i> <?= htmlspecialchars($username) ?>
                        </button>
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 hidden z-30" id="userDropdownMenu">
                            <a href="<?= $dashboardLink ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-yellow-100 hover:text-gray-900"><i class="fas fa-tachometer-alt mr-1"></i> Dashboard</a>
                            <a href="<?= $logoutLink ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-yellow-100 hover:text-gray-900"><i class="fas fa-sign-out-alt mr-1"></i> Logout</a>
                        </div>
                    </div>
                    <script>
