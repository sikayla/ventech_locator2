            ...
            <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
             ...
             <section class="mb-8">
                <div class="bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-6 rounded-lg shadow-lg flex flex-col md:flex-row justify-between items-center">
                    <div>
                        <h2 class="text-2xl font-bold mb-2">Ready for your next event?</h2>
                        <p class="mb-4 md:mb-0">Browse amazing venues available near you.</p>
                    </div>
                    <a href="/ventech_locator/user_venue_list.php" class="bg-white text-indigo-600 hover:bg-gray-100 font-bold py-2 px-5 rounded-full shadow transition duration-300 ease-in-out transform hover:scale-105 flex items-center">
                        <i class="fas fa-search mr-2"></i> Find Venues Now
                    </a>
                </div>
            </section>
                ...
                <div class="bg-white shadow-md rounded-lg overflow-x-auto">
                    <?php if (count($reservations) > 0): ?>
                        <table class="w-full table-auto text-sm text-left">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="reservation_details.php?id=<?= $reservation['id'] ?>" class="text-indigo-600 hover:text-indigo-800 text-xs font-medium">View Details</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        ...
                        <div class="p-4 text-center border-t">
                             <a href="reservations_list.php" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">View All Reservations &rarr;</a>
                        </div>
                        <?php endif; ?>
                    <?php else: ?>
